...
<div class="card">
  ...
  <form action="index.php?controller=ProductController&action=login" method="post">
    <div class="field">
      ...
      <input autocomplete="off" id="logemail" placeholder="Usuario" class="input-field" name="nombre" type="text" >
    </div>
    <div class="field">
      <svg class="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
    ...
    <button class="btn" type="submit" value="Iniciar Sesión">Login</button>
  </form>
  </center>
</div>
</div>
